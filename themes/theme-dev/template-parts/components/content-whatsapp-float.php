<?php if (get_field('informacoes_gerais_whatsapp_link', 'option')): ?>
    <a class="w-14 lg:w-16 h-14 lg:h-16 bottom-4 right-4 transition hover:scale-90 shadow-lg rounded-full fixed flex justify-center items-center bg-[#25D366] bg-opacity-80 z-50"
        ...
        <svg class="w-8 lg:w-10 h-8 lg:h-10 fill-white" xmlns="http://www.w3.org/2000/svg"
